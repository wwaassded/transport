...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)             \
    ...
    //1010100100001100010101101010011
    INSTPAT_START();
    ...
    INSTPAT("??????? ????? ????? 010 ????? 11100 11", csrrs, I, _R(rd) = _CR(imm); _CR(imm) |= src1);
    INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall, I, s->dnpc = isa_raise_intr(_R(17), 0));
