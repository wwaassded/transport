...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)         \
  ...
  INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt, R, _R(rd) = 0; if(src1 < src2) _R(rd)=1);
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, int64_t tmp = (int64_t)src1 * (int64_t)src2; _R(rd) = BITS(tmp,63,32));
